...
-- 2. ACTUALIZAR REGISTROS EXISTENTES PRIMERO
UPDATE pedidos SET estado = 'PENDIENTE' WHERE estado = 'PEDIDO';
UPDATE pedidos SET estado = 'COMPLETADO' WHERE estado = 'ENTREGADO';
UPDATE pedidos SET estado = 'COMPLETADO' WHERE estado = 'LIQUIDADO';

-- 3. CREAR NUEVO CONSTRAINT DESPUÉS DE ACTUALIZAR DATOS
ALTER TABLE pedidos ADD CONSTRAINT pedidos_estado_check 
  CHECK (estado IN ('PENDIENTE', 'COMPLETADO', 'CANCELADO'));

-- 4. ELIMINAR TODAS LAS VERSIONES ANTERIORES DE LA FUNCIÓN
...
-- 5. CREAR FUNCIÓN FINAL CON ESTADOS CORRECTOS
