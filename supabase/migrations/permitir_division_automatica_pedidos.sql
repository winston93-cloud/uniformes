-- Modificar función crear_pedido_atomico para soportar división automática de partidas
-- Descontar solo cantidad_con_stock del inventario, NO la cantidad total
...
'Crea pedido con división automática. Descuenta solo cantidad_con_stock del inventario, el resto queda como pendiente.';
